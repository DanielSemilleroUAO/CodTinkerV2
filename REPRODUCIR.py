...
class Reproducir(object):
    def __init__(self):
        self.VOZ = ["background", "Organico.mp3", "Plastico.mp3", "Vidrio.mp3", "PapelCarton.mp3","PapelCarton.mp3", "Metal.mp3", "PapelCarton.mp3", "Organico.mp3", "Organico.mp3", "Organico.mp3", "Organico.mp3","Otros.mp3"]
